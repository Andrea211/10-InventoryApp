...
public class InventoryProvider extends ContentProvider{
    ...
    static {
        ...
        // The content URI of the form "content://com.example.piotrpiro.inventory/inventory" will map to the
        ...
        // For example, "content://com.example.piotrpiro.inventory/inventory/3" matches, but
        // "content://com.example.piotrpiro.inventory/inventory" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case INVENTORY_ID:
                ...
                // For an example URI such as "content://com.example.piotrpiro.inventory/inventory/3",
